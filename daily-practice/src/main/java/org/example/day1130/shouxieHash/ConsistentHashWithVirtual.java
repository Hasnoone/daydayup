    ...
    public static void main(String[] args) {
        ...
        for (String server : servers) {
            ...
            for (int i = 0; i < virtualCount; i++) {
                int virtualIndex = Math.abs((server + "#" + i).hashCode());
                //存储server和节点的对应关系
                hashServerMap.put(virtualIndex, "虚拟节点" + i + "映射过来的请求:" + server);
            }
        }


        //针对客户端,求出hash值
        String[] clients = {"10.128.12.3", "113.124.63.1", "126.102.3.8","126.102.98","126.102.99"};
